...
app.use(cors({
  origin: ['http://localhost:3000','https://www.prkmit.in','https://prkmit-git-navraas-25-arnav22agarwal-gmailcoms-projects.vercel.app/'], // Change to the actual URL of your frontend
