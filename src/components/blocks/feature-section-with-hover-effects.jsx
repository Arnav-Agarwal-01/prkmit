...
const Feature = ({
  ...
  return (
    <div
      ...
      {index < 4 && (
        <div
          className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-t from-orange-200 dark:from-neutral-800 to-transparent pointer-events-none" />
      )}
      {index >= 4 && (
        <div
          className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-b from-orange-200 dark:from-neutral-800 to-transparent pointer-events-none" />
      )}
      <div
      ...
      <p
        className={`text-lg text-white dark:text-neutral-300 max-w-xs relative z-10 px-10 ${familyName.className}`}>
        {description}
      </p>
    </div>
  );
