...
const FlipCard = React.memo(React.forwardRef((
  {
    className,
...
const FlipCardFront = React.memo(React.forwardRef(({ className, ...props }, ref) => {
...
const FlipCardBack = React.memo(React.forwardRef(({ className, ...props }, ref) => {
  const { isFlipped, flipDirection } = useFlipCardContext()
